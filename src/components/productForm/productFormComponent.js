    ...
    return (
            ...
            <fieldset>
                ...
                <ul className='mainFieldNotificationBlock'>
                    ...
                    <li><span className='warning'>{notification('sku', newProduct)}</span></li>
                </ul>
                </li>
                <li>
                <ul className='mainFieldNotificationBlock'>
                    ...
                    <li><span className='warning'>{notification('name', newProduct)}</span></li>
                </ul>
                </li>
                <li>
                <ul className='mainFieldNotificationBlock'>
                    ...
                    <li><span className='warning'>{notification('price', newProduct)}</span></li>
                </ul>
                </li>  
                <li>
